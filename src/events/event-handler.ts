...
export class EventHandler {
  ...
  async handleEvent(context: Context): Promise<void> {
    try {
      ...
      this.logger.error(
        `Event handling failed: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
      throw error;
    }
  }

  private async handlePullRequestEvent(context: Context): Promise<void> {
  ...
  private async handleIssueCommentEvent(context: Context): Promise<void> {
  ...
  private async handlePullRequestReviewEvent(context: Context): Promise<void> {
  ...
  private async handleCommentCommand(
    prNumber: number,
    commentBody: string,
  ...
  private containsCommand(commentBody: string): boolean {
